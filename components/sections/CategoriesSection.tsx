...
import { TreePine, Landmark, Mountain, Utensils, Compass, Calendar, ArrowRight } from "lucide-react";

const categories = [
  {
    icon: TreePine,
    title: "Natureza",
    description: "Parques, trilhas e reservas de Mata Atlântica preservada.",
  ...
  },
  {
    ...
    description: "Igrejas barrocas, museus e o rico patrimônio histórico da cidade.",
  ...
  },
  {
    icon: Mountain,
    title: "Aventura",
    description: "Trekking, escalada e experiências radicais em meio à natureza.",
    image: "https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=600&q=80",
    color: "from-blue-500 to-indigo-600",
    href: "/attractions?category=adventure",
    count: "2 atrações",
  },
  {
    icon: Utensils,
    title: "Gastronomia",
    description: "Culinária mineira autêntica e produtos artesanais da região.",
  ...
  },
  {
    icon: Compass,
    title: "Patrimônio",
    description: "Fazendas históricas e edificações tombadas pelo IEPHA.",
  ...
  },
  {
    icon: Calendar,
    title: "Eventos",
    description: "Festivais, feiras e celebrações culturais durante todo o ano.",
